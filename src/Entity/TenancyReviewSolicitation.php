...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TenancyReviewSolicitationRepository")
 * @Gedmo\SoftDeleteable(fieldName="deletedAt", timeAware=false, hardDelete=false)
 */
class TenancyReviewSolicitation
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="TenancyReview")
     * @ORM\JoinColumn(name="tenancy_review_id", referencedColumnName="id")
     */
    ...
    public function setSenderUser(User $senderUser): self
    {
        ...
        if ($senderUser->getAdminAgency() !== $this->getBranch()->getAgency()) {
            throw new LogicException('Attempted to set TenancyReviewSolicitation SenderUser as User that is not associated with Branch Agency.');
        }
