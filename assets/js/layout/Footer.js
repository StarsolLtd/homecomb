          ...
          <ul className="navbar-nav">
            ...
            {props.user && props.user.agencyAdmin &&
              <li className="list-inline-item">
                <a href="/verified/dashboard" className="nav-link agency-admin-link">Agency Admin</a>
              </li>
            }
            {props.user && !props.user.agencyAdmin &&
              <li className="list-inline-item">
                <a href="/verified/agency/create" className="nav-link create-agency-link">Add Your Agency</a>
              </li>
            }
