...
e2e-public:
	make e2e-review-solicitation-response e2e-flag-review e2e-register e2e-submit-tenancy-review e2e-search-for-property-and-review e2e-find-property-by-postcode e2e-complete-survey e2e-submit-contact-form e2e-submit-locale-review
...
e2e-submit-tenancy-review:
	PANTHER_NO_HEADLESS=1 vendor/bin/phpunit --no-coverage tests/E2E/SubmitTenancyReview.php
